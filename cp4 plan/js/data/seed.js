const SEED_DATA = {
  weeks: [
    {
      ...
      days: [
        ...
        },
        {
          ...
          chapterRef: "1.6",
          sections: [{ key: "w1d6_1.6", title: "Ad Hoc Problems First Half" }]
        },
        {
          dayNum: 7,
    ...
    },
    {
      ...
      days: [
        ...
        {
          dayNum: 6,
          topic: "A* / IDA* + Ch3 Exercises & Notes",
          chapterRef: "9.20,3.6,3.7",
          sections: [
            { key: "w3d6_9.20", title: "A* and IDA*" },
            { key: "w3d6_3.6", title: "Ch3 Exercises" },
            { key: "w3d6_3.7", title: "Ch3 Chapter Notes" }
          ]
        },
        {
          dayNum: 7,
          topic: "CF Practice — Complete Search & D&C",
          chapterRef: "Practice",
          sections: [
            { key: "w3d7_cf_practice", title: "CF Practice: Complete Search + Binary Search problems" }
          ]
        }
      ],
      checklist: [
        ...
        "Completed Ch3 exercises",
        "Solved 5+ CF complete search problems"
      ]
    },
    {
      weekNum: 4,
      ...
      days: [
        {
          ...
          chapterRef: "3.4",
          sections: [
            { key: "w4d1_3.4.1", title: "Greedy Examples" },
            { key: "w4d1_3.4.2", title: "Greedy in Contests" }
          ]
        },
        {
          dayNum: 2,
          ...
          chapterRef: "3.5.1",
          sections: [{ key: "w4d2_3.5.1", title: "DP Illustration" }]
        },
        {
          dayNum: 3,
          topic: "Classical DP",
          chapterRef: "3.5.2",
          sections: [{ key: "w4d3_3.5.2", title: "Classical Examples" }]
        },
        {
          dayNum: 4,
          ...
          sections: [
            { key: "w4d4_3.5.3", title: "Non-Classical Examples" },
            { key: "w4d4_3.5.4", title: "DP in Contests" }
          ]
        },
        {
          dayNum: 5,
          ...
          sections: [
            { key: "w4d5_8.3.1", title: "DP with Bitmask" },
            { key: "w4d5_8.3.2", title: "Common DP Parameters" },
            { key: "w4d5_8.3.3", title: "Negative Offset Handling" },
            { key: "w4d5_8.3.4", title: "State Optimization" }
          ]
        },
        {
          dayNum: 6,
          topic: "Advanced DP 2 + Matrix Chain + DP Optimization",
          chapterRef: "8.3.5-8.3.9,9.7,9.23",
          sections: [
            { key: "w4d6_8.3.5", title: "Reduce Parameters" },
            { key: "w4d6_8.3.6", title: "Multi-test optimization" },
            { key: "w4d6_8.3.7", title: "Hash memo" },
            { key: "w4d6_8.3.8", title: "Binary search optimization" },
            { key: "w4d6_8.3.9", title: "Other DP techniques" },
        ...
        {
          dayNum: 7,
          topic: "CF Practice — Greedy + DP",
          chapterRef: "Practice",
          sections: [{ key: "w4d7_cf_practice", title: "CF Practice: Greedy + DP problems" }]
        }
      ],
      checklist: [
        "Understand and solved greedy problems",
        ...
        "Solved 5+ CF greedy + DP problems"
      ]
    },
    {
      weekNum: 5,
      title: "Graph Basics - D&C + Greedy + Ch4",
      officialPlan: "Week 05: Graph Basics - Chapter 4 (+ Ch3 D&C & Greedy)",
      ...
      days: [
        ...
        },
        {
          ...
          sections: [
            { key: "w5d2_4.1", title: "Graph Overview" },
            { key: "w5d2_4.2.1", title: "Graph Traversal Overview" },
            { key: "w5d2_4.2.2", title: "DFS" },
            { key: "w5d2_4.2.3", title: "BFS" },
            { key: "w5d2_4.2.4", title: "Connected Components" },
            { key: "w5d2_4.2.5", title: "Flood Fill" },
            { key: "w5d2_4.2.6", title: "Topological Sort" }
          ]
        },
        {
          dayNum: 3,
          ...
          sections: [
            { key: "w5d3_4.2.7", title: "Bipartite Check" },
            { key: "w5d3_4.2.8", title: "Cycle Check" },
            { key: "w5d3_4.2.9", title: "Bridges" },
            { key: "w5d3_4.2.10", title: "SCC" },
            { key: "w5d3_4.2.11", title: "Graph Traversal in Contests" }
          ]
        },
        {
          dayNum: 4,
          topic: "MST + SSSP (full coverage)",
          chapterRef: "4.3,4.4",
          sections: [
            { key: "w5d4_4.3.1", title: "MST Overview" },
            { key: "w5d4_4.3.2", title: "Kruskal" },
            { key: "w5d4_4.3.3", title: "Prim" },
            { key: "w5d4_4.3.4", title: "MST Other Applications" },
            { key: "w5d4_4.3.5", title: "MST in Contests" },
            { key: "w5d4_4.4.1", title: "SSSP Overview" },
            { key: "w5d4_4.4.2", title: "BFS SSSP" },
            { key: "w5d4_4.4.3", title: "Dijkstra" },
            { key: "w5d4_4.4.4", title: "Bellman-Ford" },
            { key: "w5d4_4.4.5", title: "SSSP in Contests" }
          ]
        },
        {
          dayNum: 5,
          topic: "APSP (full) + Special Graphs + Exercises",
          chapterRef: "4.5,4.6,4.7,4.8",
          sections: [
            { key: "w5d5_4.5.1", title: "APSP Overview" },
            { key: "w5d5_4.5.2", title: "Floyd-Warshall" },
            { key: "w5d5_4.5.3", title: "APSP Other Applications" },
            { key: "w5d5_4.5.4", title: "APSP in Contests" },
            { key: "w5d5_4.6.1", title: "DAG" },
            { key: "w5d5_4.6.2", title: "Tree" },
            { key: "w5d5_4.6.3", title: "Bipartite Graph" },
            { key: "w5d5_4.6.4", title: "Eulerian Graph" },
            { key: "w5d5_4.6.5", title: "Special Graphs in Contests" },
            { key: "w5d5_4.7", title: "Ch4 Exercises" },
            { key: "w5d5_4.8", title: "Ch4 Chapter Notes" }
          ]
        },
        {
          dayNum: 6,
          topic: "Rare Tree Topics — HLD + LCA + Tree Isomorphism",
          chapterRef: "9.5,9.8,9.9",
          sections: [
        ...
        {
          dayNum: 7,
          topic: "CF Practice — Graph",
          chapterRef: "Practice",
          sections: [{ key: "w5d7_cf_practice", title: "CF Practice: Graph traversal + shortest path problems" }]
        }
      ],
      checklist: [
        "Completed D&C and Binary Search on answer",
        "Implemented DFS/BFS/Dijkstra",
        "Implemented Kruskal and Prim",
        "Implemented Floyd-Warshall",
        "Implemented SCC and Bridges",
        "Understand HLD/LCA/Tree Isomorphism",
        "Solved 5+ CF graph problems"
      ]
    },
    {
      weekNum: 6,
      title: "Mid-Semester Team Contest - Entire Book 1",
      officialPlan: "Week 06: Buffer slot + Mid-Semester Team Contest - Entire Book 1",
    ...
    },
    {
      ...
      days: [
        ...
        { dayNum: 7, topic: "Min Cost Flow + CF Practice", chapterRef: "9.25,Practice", sections: [{ key: "w7d7_9.25", title: "Min Cost Flow" }, { key: "w7d7_cf_practice", title: "CF Practice: Network Flow problems" }] }
      ],
      checklist: [
    ...
    },
    {
      ...
      days: [
        ...
        { dayNum: 6, topic: "Chinese Postman", chapterRef: "9.29", sections: [{ key: "w8d6_9.29", title: "Chinese Postman" }] },
        { dayNum: 7, topic: "CF Practice — Flow + Matching", chapterRef: "Practice", sections: [{ key: "w8d7_cf_practice", title: "CF Practice: Flow + Matching problems" }] }
      ],
      checklist: [
    ...
    },
    {
      ...
      isMidBreakAfter: false,
      days: [
        { dayNum: 1, topic: "NP-hard — Prelims + Pseudo-poly + TSP", chapterRef: "8.6.1,8.6.2,8.6.3", sections: [{ key: "w9d1_8.6.1", title: "8.6.1 Preliminaries" }, { key: "w9d1_8.6.2", title: "8.6.2 Pseudo-Polynomial (Knapsack, Subset-Sum)" }, { key: "w9d1_8.6.3", title: "8.6.3 TSP" }] },
        { dayNum: 2, topic: "NP-hard — Graph problems", chapterRef: "8.6.4-8.6.8", sections: [{ key: "w9d2_8.6.4", title: "8.6.4 Hamiltonian Path/Tour" }, { key: "w9d2_8.6.5", title: "8.6.5 Longest Path" }, { key: "w9d2_8.6.6", title: "8.6.6 Max-Independent-Set + Min-Vertex-Cover" }, { key: "w9d2_8.6.7", title: "8.6.7 Min-Set-Cover" }, { key: "w9d2_8.6.8", title: "8.6.8 Min-Path-Cover" }] },
        { dayNum: 3, topic: "NP-hard — SAT + Coloring + Summary", chapterRef: "8.6.9-8.6.14", sections: [{ key: "w9d3_8.6.9", title: "8.6.9 SAT" }, { key: "w9d3_8.6.10", title: "8.6.10 Steiner Tree" }, { key: "w9d3_8.6.11", title: "8.6.11 Graph Coloring" }, { key: "w9d3_8.6.12", title: "8.6.12 Min-Clique-Cover" }, { key: "w9d3_8.6.13", title: "8.6.13 Other NP-hard" }, { key: "w9d3_8.6.14", title: "8.6.14 Summary" }] },
        { dayNum: 4, topic: "Problem Decomposition 1", chapterRef: "8.7", sections: [{ key: "w9d4_8.7", title: "Problem Decomposition (first half)" }] },
    ...
    },
    {
      ...
      days: [
        ...
        { dayNum: 7, topic: "Rare math + CF Practice", chapterRef: "9.12-9.17,Practice", sections: [{ key: "w10d7_9.12", title: "Pollard's Rho" }, { key: "w10d7_9.13", title: "CRT" }, { key: "w10d7_9.14", title: "Lucas" }, { key: "w10d7_9.15", title: "Rare theorems" }, { key: "w10d7_9.16", title: "Combinatorial game theory" }, { key: "w10d7_9.17", title: "Gaussian elimination" }, { key: "w10d7_cf_practice", title: "CF Practice: Number theory problems" }] }
      ],
      checklist: [
        "Implemented sieve",
    ...
    },
    {
      ...
      days: [
        ...
        { dayNum: 7, topic: "Anagram + Palindrome + De Bruijn + FFT + CF Practice", chapterRef: "6.7,6.8,6.9,9.10,9.11,Practice", sections: [{ key: "w11d7_6.7.1", title: "Anagram" }, { key: "w11d7_6.7.2", title: "Palindrome" }, { key: "w11d7_9.10", title: "De Bruijn Sequence" }, { key: "w11d7_9.11", title: "FFT" }, { key: "w11d7_6.8", title: "Exercises" }, { key: "w11d7_6.9", title: "Chapter Notes" }, { key: "w11d7_cf_practice", title: "CF Practice: String problems" }] }
      ],
      checklist: [
        "Implemented KMP",
    ...
    },
    {
      ...
      days: [
        ...
        { dayNum: 7, topic: "Art Gallery + Closest Pair + CF Practice", chapterRef: "9.18,9.19,7.5,7.6,Practice", sections: [{ key: "w12d7_9.18", title: "Art Gallery" }, { key: "w12d7_9.19", title: "Closest Pair" }, { key: "w12d7_7.5", title: "Exercises" }, { key: "w12d7_7.6", title: "Chapter Notes" }, { key: "w12d7_cf_practice", title: "CF Practice: Geometry problems" }] }
      ],
      checklist: [
    ...
    {
      weekNum: 14,
      title: "Final Preparation & Rating Push",
      officialPlan: "Week 14: Final Preparation & Rating Push - Entire Book 1+2 + CF Virtual Contests",
      chapters: ["Entire CP4 book", "9.34 revisit"],
      isMidBreakAfter: false,
      days: [
        { dayNum: 1, topic: "Review confused sections + Optional rare topics", chapterRef: "Review,9.6,9.21,9.22", sections: [
            { key: "w14d1_review", title: "Review all confused sections from mistake log" },
            { key: "w14d1_9.6", title: "9.6 Tower of Hanoi (optional)" },
            { key: "w14d1_9.21", title: "9.21 Pancake Sorting (optional)" },
            { key: "w14d1_9.22", title: "9.22 Egg Dropping (optional)" }
          ]
        },
        { dayNum: 2, topic: "CF Drill — weak topic #1", chapterRef: "Practice", sections: [{ key: "w14d2_cf_drill1", title: "CF Drill: Targeted practice on weakest topic from mistake log" }] },
        { dayNum: 3, topic: "CF Drill — weak topic #2", chapterRef: "Practice", sections: [{ key: "w14d3_cf_drill2", title: "CF Drill: Targeted practice on second weakest topic" }] },
        { dayNum: 4, topic: "Virtual Contest — timed Div. 2", chapterRef: "Contest", sections: [{ key: "w14d4_virtual_contest", title: "Virtual Contest: Full Div. 2 round (2.5 hrs timed)" }] },
      ...
      checklist: [
        "Reviewed all confused sections from mistake log",
        "Completed CF drill on weak topic #1",
        "Completed CF drill on weak topic #2",
        "Virtual contest completed and upsolved",
  ...
  ch9Map: {
    ...
    "9.6  Tower of Hanoi": { week: 14, day: 1, key: "w14d1_9.6", note: "optional — review if time allows" },
    ...
    "9.10 De Bruijn": { week: 11, day: 7, key: "w11d7_9.10" },
    ...
    "9.21 Pancake Sorting": { week: 14, day: 1, key: "w14d1_9.21", note: "optional — review if time allows" },
    "9.22 Egg Dropping": { week: 14, day: 1, key: "w14d1_9.22", note: "optional — review if time allows" },
